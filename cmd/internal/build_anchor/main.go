...
func buildAndroid() {
	...
	args = append(args, "./experimental/anchorcore")
...
func buildApple() {
	...
	if rw.IsDir(copyPath) {
		targetDir := filepath.Join(copyPath, "AnchorCore.xcframework")
		targetDir, _ = filepath.Abs(targetDir)
		os.RemoveAll(targetDir)
		os.Rename("AnchorCore.xcframework", targetDir)
