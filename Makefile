...
lib_android:
	go run ./cmd/internal/build_anchor -target android

lib_android_debug:
	go run ./cmd/internal/build_anchor -target android -debug

lib_apple:
	go run ./cmd/internal/build_anchor -target apple

lib_ios:
	go run ./cmd/internal/build_anchor -target apple -platform ios -debug

lib:
	go run ./cmd/internal/build_anchor -target android
	go run ./cmd/internal/build_anchor -target ios
...
clean:
	rm -rf bin dist anchor
	rm -f $(shell go env GOPATH)/anchor
